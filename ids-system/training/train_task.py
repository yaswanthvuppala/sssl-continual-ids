...
def main():
    ...
    if args.dataset:
        ...
        df_labeled = loader.load_dataset(args.dataset, split="train", label_col=args.label_col, max_samples=max_samples)
    ...
    try:
        ...
        # Combined model wrapper for GPM — exposes encoder+head vars when unfrozen
